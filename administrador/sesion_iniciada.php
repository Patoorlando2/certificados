...
<div class="container mt-3 bg bg-light w-50 shadow-lg rounded">
  ...
  <div class="row p-5">
    ...
    <div class="col-lg-12 mt-3">
      <h2 class="text-center">Cargar datos</h2>
    </div>
  ...
  <div class="row">
    ...
    <form action="cargar_datos.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="col-lg-12">
        ...
        <input class="form-control" type="file" placeholder="Archivo" name="archivo" />
      </div>


      <div class="col-lg-12">
        <!-- Botón cargar datos -->
        <button type="submit" class="btn btn-primary mt-3 mb-3">Cargar datos</button>
