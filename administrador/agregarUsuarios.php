...
<div class="col-lg-12 mt-3">
  <h2 class="text-center">Creación de usuarios al sistema</h2>
</div>
...
<form action="backAgregarUsuarios.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="col-lg-12">
    <!-- Botón cargar datos -->
    <button type="submit" class="btn btn-primary mt-3 mb-3">Agregar usuario</button>
