...
<div class="container mt-3 bg bg-light w-50 shadow-lg rounded">
  ...
  <div class="row">
    ...
    <form action="back_modificar.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">

      <div class="col-lg-12">
        <!-- Nombre -->
            <label for="nombreyapellido" class="form-label">Nombres:</label>
            <input class="form-control" type="text" placeholder="Nombre y apellido" name="nombres">
      </div>

      <div class="col-lg-12">
        <!--Cédula -->
        <label for="cedula" class="form-label">Cédula:</label>
        <input class="form-control" type="number" placeholder="Cédula" name="cedula" />
      </div>
      ...
      <div class="col-lg-12">
        <!-- Botón cargar datos -->
        <button type="submit" class="btn btn-primary mt-3 mb-3" >Modificar</button>
        <!--<a href="formModificarDestino.php?destID= class="btn btn-outline-secondary">Modificar</a>-->
